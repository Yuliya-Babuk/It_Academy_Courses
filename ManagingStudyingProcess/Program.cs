        ...
        static void Main(string[] args)
        {
            ...
            while (canContinue)
            {
                ...
                switch (userInput)
                {
                    ...
                    case ("us"):
                        {
                            Student student = FindStudent(groups);
                            if (student != null)
                            {
            ...
            static Student FindStudent(Groups groups)
            {
                Console.WriteLine("Input student's name:");
                ...
                {
                    Student student = group.ListOfStudents.FirstOrDefault(s => s.Name == name && s.Surname == surname);
                    if (student == null)
                    {
